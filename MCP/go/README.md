# Payment Method Tokens MCP Server

This MCP (Model Content Protocol) server provides access to Payment Method Tokens API functionality through HTTP, HTTPS, and STDIO transport modes.
